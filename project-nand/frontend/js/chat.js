$(document).ready(function() {
    var fileid = '808b2a0ac33d558ca0be678f3cb49dc8b012dca8';
    ...
    async function sendMessage() {
        ...
        try {
            ...
            const response = await fetch('https://www.bmreducation.com/medcare/ai', {
                method: 'POST',
                body: formData
            });
    ...
    $('.chat-suggestions button').on('click', async function() {
        ...
        try {
            ...
            formData.append('fileid', '808b2a0ac33d558ca0be678f3cb49dc8b012dca8');
            formData.append('conversation_history', JSON.stringify(conversationHistory));
    ...
    async function sendAudioToServer(audioBlob) {
        ...
        try {
            const response = await fetch('https://www.bmreducation.com/medcare/audio-text', {
                method: 'POST',
                body: formData
            });
    ...
    function resetConversation() {
        ...
        fileid = '808b2a0ac33d558ca0be678f3cb49dc8b012dca8';
    ...
    function handleFileUpload() {
        ...
        $fileInput.on('change', async function(e) {
            ...
            try {
                ...
                const response = await fetchWithTimeout('https://www.bmreducation.com/medcare/file-upload', {
                    method: 'POST',
                    body: formData
                }, 30000);
